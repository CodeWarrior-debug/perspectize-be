...
- **Global scope**: `/Users/jamesjordan/GitHub/perspectize/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/jamesjordan/GitHub/perspectize/.claude/notes/`)
...
2. Glob `/Users/jamesjordan/GitHub/perspectize/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/jamesjordan/GitHub/perspectize/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/jamesjordan/GitHub/perspectize/.claude/notes/` — works in any directory
