...
must_haves:
  ...
  artifacts:
    - path: "fe/src/lib/queries/client.ts"
    ...
    - path: "fe/vite.config.ts"
      ...
      contains: "test:"
    - path: "fe/src/routes/+layout.svelte"
      provides: "Root layout with QueryClientProvider and Toaster"
      contains: "QueryClientProvider"
  key_links:
    - from: "fe/src/routes/+layout.svelte"
...
<task type="auto">
  ...
  <verify>
    ...
    ```bash
    grep -r "QueryClientProvider" fe/src/routes/+layout.svelte
    grep "@tanstack/svelte-form" fe/package.json
    ```
