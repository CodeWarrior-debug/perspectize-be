...
must_haves:
  ...
  artifacts:
    - path: "frontend/tests/unit/utils.test.ts"
      provides: "Unit tests for cn() utility"
      contains: "cn("
      min_lines: 20
    - path: "frontend/tests/unit/queries-client.test.ts"
    ...
    - path: "frontend/tests/components/Header.test.ts"
      ...
      contains: "Header"
      min_lines: 20
    - path: "frontend/tests/components/PageWrapper.test.ts"
      provides: "Component tests for PageWrapper.svelte"
      contains: "PageWrapper"
      min_lines: 20
    - path: "frontend/tests/helpers/render.ts"
    ...
    - path: "frontend/vite.config.ts"
      ...
      contains: "thresholds"
  key_links:
    - from: "frontend/tests/components/Header.test.ts"
      to: "frontend/src/lib/components/Header.svelte"
      via: "import and render"
      pattern: "import.*Header"
    - from: "frontend/tests/components/PageWrapper.test.ts"
      to: "frontend/src/lib/components/PageWrapper.svelte"
      via: "import and render"
...
<task type="auto">
  ...
  <verify>
    ...
    ```bash
    grep -r "1 + 1" frontend/tests/
    ```
    No results (placeholder removed).

    Verify test helper exists:
    ```bash
    test -f frontend/tests/helpers/render.ts && echo "exists"
    ```
  </verify>
  <done>
...
<task type="auto">
  ...
  <verify>
    ...
    ```bash
    grep -q "thresholds" frontend/vite.config.ts && echo "thresholds configured"
    ```

    Verify test organization:
    ```bash
    ls frontend/tests/unit/ frontend/tests/components/ frontend/tests/helpers/
    ```
