...
5. `grep -q "Dialog" perspectize-fe/src/lib/components/shadcn/index.ts` -- Dialog exported
6. `grep -q "Input" perspectize-fe/src/lib/components/shadcn/index.ts` -- Input exported
7. `grep -q "Label" perspectize-fe/src/lib/components/shadcn/index.ts` -- Label exported
</verification>
