...
must_haves:
  ...
  artifacts:
    - path: "fe/src/lib/components/AddVideoDialog.svelte"
    ...
    - path: "fe/tests/components/AddVideoDialog.test.ts"
...
<task type="checkpoint:human-verify" gate="blocking">
  ...
  <how-to-verify>
    Prerequisites: Backend must be running (`cd backend && make run`)
