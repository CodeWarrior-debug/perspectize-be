...
must_haves:
  ...
  artifacts:
    ...
    - path: "frontend/tests/components/AddVideoDialog.test.ts"
    ...
    - path: "frontend/tests/components/Header.test.ts"
      ...
      min_lines: 30
  key_links:
    - from: "frontend/src/lib/components/AddVideoDialog.svelte"
