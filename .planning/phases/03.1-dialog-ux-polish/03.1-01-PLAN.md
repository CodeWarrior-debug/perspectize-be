...
must_haves:
  ...
  artifacts:
    ...
    - path: "perspectize-fe/static/fonts/Charter-Regular.woff2"
...
@perspectize-fe/src/app.css
@perspectize-fe/src/lib/components/shadcn/button/button.svelte
...
Verify woff2 format: `file perspectize-fe/static/fonts/Charter-*.woff2` should show "Web Open Font Format" or similar binary font indicator (not HTML/text).
  </verify>
...
7. `grep 'font-family-serif' perspectize-fe/src/app.css` matches (serif font defined)
</verification>
