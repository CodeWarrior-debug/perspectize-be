...
files_modified:
  ...
  - perspective-frontend/src/lib/components/ActivityTable.svelte
  - perspective-frontend/src/lib/utils/formatting.ts
  - perspective-frontend/src/routes/+page.svelte
  - perspective-frontend/src/app.css
  - perspective-frontend/tests/unit/formatting.test.ts
  - perspective-frontend/tests/components/ActivityTable.test.ts
autonomous: true
...
must_haves:
  ...
  artifacts:
    - path: "perspective-frontend/src/lib/queries/content.ts"
    ...
    - path: "perspective-frontend/src/lib/components/ActivityTable.svelte"
      ...
      min_lines: 100
    - path: "perspective-frontend/src/routes/+page.svelte"
      provides: "Activity page with manual pagination controls, no global search bar"
      contains: "ActivityTable"
    - path: "perspective-frontend/src/lib/utils/formatting.ts"
      provides: "Formatters for view count, like count, YouTube icon renderer, thumbnail renderer"
      contains: "formatCount"
  key_links:
    - from: "perspective-frontend/src/lib/components/ActivityTable.svelte"
      to: "perspective-frontend/src/lib/queries/content.ts"
      via: "graphqlClient.request(LIST_CONTENT, variables)"
      pattern: "graphqlClient\\.request"
    - from: "perspective-frontend/src/routes/+page.svelte"
      to: "perspective-frontend/src/lib/components/ActivityTable.svelte"
...
Key existing files:
@perspective-frontend/src/lib/components/ActivityTable.svelte
@perspective-frontend/src/lib/queries/content.ts
@perspective-frontend/src/routes/+page.svelte
@perspective-frontend/src/lib/utils/formatting.ts
@perspective-frontend/src/app.css
</context>
...
<task type="auto">
  ...
  <verify>
    ...
    - `grep "channelTitle" perspective-frontend/src/lib/queries/content.ts` shows new fields in query
    - `grep "formatCount" perspective-frontend/src/lib/utils/formatting.ts` shows new utility
  </verify>
  <done>
