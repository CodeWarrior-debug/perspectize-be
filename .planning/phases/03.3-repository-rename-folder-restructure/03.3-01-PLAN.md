...
<task type="auto">
  ...
  <action>
    ...
    **IMPORTANT: Do NOT rename any folders in this task.** Folders stay as `backend/` and `frontend/`. Folder rename happens in Plan 02 after Go module refactoring is verified.
