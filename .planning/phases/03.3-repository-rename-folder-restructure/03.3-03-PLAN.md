...
<task type="auto">
  ...
  <action>
    ...
    **Step 4: Final stale reference check**
    ...
    grep -rn "fe/" . --exclude-dir=node_modules --exclude-dir=.git --exclude-dir=fe --include="*.go" --include="*.yml" --include="*.yaml" --include="*.md" --include="*.json" --include="*.ts" --include="*.svelte"
    ```
...
- Completeness: No references to backend/, fe/, or perspectize in source files
</verification>
