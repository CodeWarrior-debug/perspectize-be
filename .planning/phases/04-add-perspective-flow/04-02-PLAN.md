...
depends_on: ["04-01"]
files_modified:
  - frontend/src/lib/components/AddPerspectiveDialog.svelte
  - frontend/src/lib/components/Header.svelte
  - frontend/tests/components/AddPerspectiveDialog.test.ts
...
must_haves:
  ...
  artifacts:
    - path: "frontend/src/lib/components/AddPerspectiveDialog.svelte"
