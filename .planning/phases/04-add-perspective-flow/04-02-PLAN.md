...
depends_on: ["04-01"]
files_modified:
  - perspectize-fe/src/lib/components/AddPerspectiveDialog.svelte
  - perspectize-fe/src/lib/components/Header.svelte
  - perspective-fe/tests/components/AddPerspectiveDialog.test.ts
...
must_haves:
  ...
  artifacts:
    - path: "perspectize-fe/src/lib/components/AddPerspectiveDialog.svelte"
    ...
    - path: "perspectize-fe/tests/components/AddPerspectiveDialog.test.ts"
    ...
    - path: "perspectize-fe/tests/components/Header.test.ts"
      ...
      min_lines: 30
  key_links:
    - from: "perspectize-fe/src/lib/components/AddPerspectiveDialog.svelte"
      to: "perspectize-fe/src/lib/queries/perspectives.ts"
    ...
    - from: "perspectize-fe/src/lib/components/AddPerspectiveDialog.svelte"
      to: "perspectize-fe/src/lib/components/RatingInput.svelte"
      via: "uses RatingInput for 4 rating fields"
      pattern: "RatingInput"
    - from: "perspectize-fe/src/lib/components/AddPerspectiveDialog.svelte"
      to: "perspectize-fe/src/lib/components/VideoSelector.svelte"
      via: "uses VideoSelector for content selection"
      pattern: "VideoSelector"
    - from: "perspectize-fe/src/lib/components/Header.svelte"
      to: "perspectize-fe/src/lib/components/AddPerspectiveDialog.svelte"
...
<task type="checkpoint:human-verify" gate="blocking">
  ...
  <how-to-verify>
    Prerequisites: Backend must be running (`cd perspectize-go && make run`). At least one video must exist in the database. At least one user must exist.

    1. Start frontend: `cd perspective-fe && pnpm run dev`
