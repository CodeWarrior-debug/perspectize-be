...
must_haves:
  ...
  artifacts:
    - path: "fe/tests/components/UserSelector.test.ts"
    ...
    - path: "fe/tests/unit/stores-userSelection.test.ts"
      ...
      min_lines: 30
  key_links:
    - from: "fe/tests/components/UserSelector.test.ts"
      to: "fe/src/lib/components/UserSelector.svelte"
      via: "imports and renders component"
      pattern: "import.*UserSelector"
    - from: "fe/tests/components/ActivityTable.test.ts"
...
<task type="auto">
  ...
  <files>fe/coverage/ (generated output, not committed)</files>
  <action>
