...
import (
	...
	"github.com/CodeWarrior-debug/perspectize-be/apps/backend/internal/adapters/repositories/postgres"
	"github.com/CodeWarrior-debug/perspectize-be/apps/backend/internal/adapters/youtube"
	"github.com/CodeWarrior-debug/perspectize-be/apps/backend/internal/config"
	"github.com/CodeWarrior-debug/perspectize-be/apps/backend/internal/core/services"
	"github.com/CodeWarrior-debug/perspectize-be/apps/backend/pkg/database"
)
